...
exports('HandleHttpRequest', (dest, callback, method, data, headers) => {
    emit("SonoranCMS::core:writeLog", "debug", "[http] to: " + dest + " - data: " + dest, JSON.stringify(data));
    ...
    options.headers['X-SonoranCMS-Version'] = GetResourceMetadata(GetCurrentResourceName(), "version", 0)
